<template>
  <div>
    <footer
      class="text-center flex justify-center flex-col text-black bg-white"
    >
      <div class="container p-6">
        <div class="flex flex-col max-w-md px-4 lg:px-8 justify-center mx-auto text-center">
          <!-- <img src="../assets/logo.png" class="w-auto mx-auto h-16" /> -->
          <button
            class="
              inline-flex
              items-center
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              class="fill-current w-7 h-7 text-coolGray-50"
            >
              <path
      ...
      <div class="text-center p-4 hero">
        © 2022 Copyright:
        <span class="text-black">Thispatch</span>
      </div>
    </footer>
  </div>
</template>
